...
interface EditMetadataModalProps {
  song: Song;
  onClose: () => void;
  onSave: (metadata: { title: string; artist: string; album: string }) => Promise<void>;
}

export default function EditMetadataModal({ song, onClose, onSave }: EditMetadataModalProps) {
