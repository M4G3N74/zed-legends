...
interface FolderRowProps {
  ...
  onRename: (item: R2File) => void;
}

const FolderRow = ({ file, currentPath, handleNavigate, onRename }: FolderRowProps) => {
...
export default function R2FileBrowser({ onEdit, canRename }: R2FileBrowserProps) {
  ...
  const handleRename = async (item: R2File) => {
